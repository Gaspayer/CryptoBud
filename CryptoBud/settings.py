"""
Django settings for CryptoBud project.
...
SECRET_KEY = 'django-insecure-by6^k5lbv9-3m!pp@w=-3!a2=_by_pg)6d-7q9dod#wctm6p&f'
...
WSGI_APPLICATION = 'CryptoBud.wsgi.application'
